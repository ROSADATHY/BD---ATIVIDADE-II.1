...
(1, 1, "isLana", "A tecnologia é o futuro!!!", '2023-05-10'),
(2, 2, "Rafaela", "Muito bom adorei!", '2023-05-16'),
(3, 3, "Lucia", "Adorei os exércicios!!", '2023-20-12'),
(4, 4, "Vitor", "Vamos trabalhar!!", '2023-16-21'),
(5, 5, "Lania", "Hoje vamos trabalhar com programação e banco de dados!!" ,'2023-06-12');
